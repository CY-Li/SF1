...
import { IPostSpsReqModel, IPutSpsReqModel } from '../sps.model';
import { SpsService } from '../sps.service';
import { MatIconModule } from '@angular/material/icon';

@Component({
  selector: 'app-sps-add-edit',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './sps-add-edit.component.html',
  styleUrl: './sps-add-edit.component.scss'
})
export class SpsAddEditComponent {
  ...
  initFormGroup() {
    ...
    return this._formBuilder.group({
      ...
      sps_parameter01: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter02: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter03: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter04: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter05: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter06: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter07: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter08: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter09: this._formBuilder.control('', Validators.maxLength(100)),
      sps_parameter10: this._formBuilder.control('', Validators.maxLength(100)),
    });
  }
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<SpsAddEditComponent>, // 關閉dialog，新增、編輯用
