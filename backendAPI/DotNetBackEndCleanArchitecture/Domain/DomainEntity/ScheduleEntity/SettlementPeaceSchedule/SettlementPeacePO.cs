...
namespace DomainEntity.ScheduleEntity.SettlementPeaceSchedule
{
    public class SettlementPeacePO
    {
        ///[Key]
        ...
        /// </summary>
        ////// [Precision(15, 5)]
        public decimal mw_peace { get; set; } = decimal.Zero;
        ...
        /// </summary>
        /// [Precision(15, 5)]
        public decimal mw_punish { get; set; } = decimal.Zero;
        ...
        /// </summary>
        /// [Column(TypeName = "int(15)")]
        public int td_pp_penalty_count { get; set; } = 0;

        /// <summary>
        /// 是否都已繳費，如果有未繳費就不是0
        /// </summary>
        /// [Column(TypeName = "int(15)")]
        public int td_pp_paid { get; set; } = 0;
    }

    public class SettlementPeaceInsertBalancePoint
    {
        /// <summary>
        /// 儲值點數(可用點數)，system_parameters:11
        /// </summary>
        ...
        /// 平安點數變動額
        /// </summary>
        public decimal mw_peace_chenge { get; set; } = decimal.Zero;
        ...
        /// 商城點數變動額
        /// </summary>
        public decimal mw_mall_chenge { get; set; } = decimal.Zero;

        /// <summary>
        /// 累積獎勵變動額
        /// </summary>
        ////// [Precision(15, 5)]
        public decimal mw_accumulation_change { get; set; } = decimal.Zero;
        ...
        /// </summary>
        /// [Precision(15, 5)]
        public decimal mw_punish_change { get; set; } = decimal.Zero;
    }
}
