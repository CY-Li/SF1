...
namespace DomainEntityDTO.Entity.FinancialMgmt.MemberBalance
{
    ...
    /// 後台-取得帳務紀錄列表
    /// </summary>
    public class QueryMemberBalanceAdminReqModel : BaseGridReqModel
    {
        /// <summary>
        /// 帳號(現在為手機號碼)
        /// </summary>
        ...
        [SwaggerSchema(Description = "點數類型，11-儲值點數、12-紅利點數、13-平安點數、14-商城點數、15-註冊點數、16-死會點數")]
    ...
    /// 會員-取得帳務紀錄列表
    /// </summary>
    public class QueryMemberBalanceUserReqModel : BaseGridReqModel
    {
